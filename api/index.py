# # main.py - COMPLETE WITH ALL ENDPOINTS + EMAIL LEAK CHECK
...
# DEFAULT_WID = "37b8f995a8e4a0022df19f368edcbf3a962ed44a"
# WID = os.getenv("EMAIL_LEAK_WID", DEFAULT_WID)

# # Get API base URL from environment variable or use default
# EMAIL_LEAK_API_BASE = os.getenv("EMAIL_LEAK_API_BASE", "https://leak.api.mywot.com")
...
#         "endpoints": {
#             # Security checks
#             "gsrcheck": "GET /gsrcheck/?url=<url>",
#             "malware": "GET /malware/?url=<url>",
#             "domain_age": "GET /domain_age/?url=<url>",
#             "enhanced": "GET /enhanced/?url=<url>",
#             "malware/enhanced": "GET /malware/enhanced/?url=<url>",
#             "super_fast": "GET /super_fast/?url=<url>",
            
#             # Email Leak Check
#             "email_leak": "GET /email-leak/?email=<email>",
#             "email_leak_batch": "POST /email-leak/batch",
            
#             # Extension scraper
#             "extension": "GET /extension/{extension_id}",
#             "extension_basic": "GET /extension/{extension_id}/basic",
#             "extension_privacy": "GET /extension/{extension_id}/privacy",
#             "extension_developer": "GET /extension/{extension_id}/developer",
#             "extensions_batch": "POST /extensions/batch",
...
# # THIS IS THE FIX - /malware/enhanced/ endpoint
# @app.get("/malware/enhanced/")
# async def malware_enhanced_check(url: str = Query(...)):
#     """Alias for /enhanced/ - keeps compatibility"""
...
#     wid: str = Query(None, description="Widget ID parameter (optional, uses env var or default if not provided)")
# ):
#     """
#     Check if an email has been compromised in data leaks
#     Uses the WOT API to scan for email breaches
#     WID can be provided as query param, or will use EMAIL_LEAK_WID env var, or default value
#     """
#     start_time = time.time()
    
#     # Use provided wid, or fallback to env var/default
...
#     # Prepare the gbData parameter
#     gb_data = {
#         "attributes": {
#             "wid": final_wid,
#             "firstRunDate": int(time.time() * 1000)  # Current timestamp in milliseconds
#         }
#     }
...
#         "Referer": "https://www.securelint.in/",
#         "Origin": "https://www.securelint.in"
#     }
...
#                 # If it's a list, treat it as the data array directly
#                 leak_data = result
#                 enhanced_result = {
#                     "email": email,
#                     "status": "success",
...
#                     "wid_used": final_wid,
#                     "api_base": EMAIL_LEAK_API_BASE,
#                     "data": leak_data,
#                     "is_compromised": len(leak_data) > 0,
#                     "leak_count": len(leak_data)
#                 }
#             elif isinstance(result, dict):
#                 # If it's a dictionary, check for data field
...
#                     "message": f"Expected dict or list, got {type(result).__name__}"
#                 }
#                 return JSONResponse(content=enhanced_result, status_code=500)
            
#             # Add summary if there are leaks
#             if enhanced_result["is_compromised"]:
#                 actual_leaks = leak_data if isinstance(result, list) else result.get("data", [])
                
#                 if actual_leaks and len(actual_leaks) > 0:
#                     leak_sources = []
#                     breach_dates = []
...
#                             # Get breach date safely
#                             breach_date = leak.get("breachDate") or leak.get("date")
#                             if breach_date and breach_date != "Unknown" and breach_date != "":
#                                 breach_dates.append(breach_date)
                            
#                             # Get compromised data types
#                             data_types = leak.get("dataTypes", []) or leak.get("compromisedData", [])
#                             if data_types:
#                                 compromised_data_types.extend(data_types)
                    
#                     # Create summary
#                     summary = {
#                         "total_leaks": len(actual_leaks),
#                         "leak_sources": list(set(leak_sources)) if leak_sources else ["Unknown"],
#                     }
                    
#                     # Add dates only if we have valid dates
#                     if breach_dates:
#                         try:
#                             summary["earliest_leak"] = min(breach_dates)
#                             summary["latest_leak"] = max(breach_dates)
#                         except (ValueError, TypeError):
#                             summary["earliest_leak"] = "Date unknown"
#                             summary["latest_leak"] = "Date unknown"
#                     else:
#                         summary["earliest_leak"] = "Date unknown"
#                         summary["latest_leak"] = "Date unknown"
                    
#                     # Add compromised data types if available
#                     if compromised_data_types:
#                         summary["compromised_data"] = list(set(compromised_data_types))
                    
#                     enhanced_result["summary"] = summary
#                 else:
#                     enhanced_result["summary"] = {
#                         "total_leaks": 0,
#                         "message": "No leak details available"
#                     }
#             else:
#                 enhanced_result["summary"] = {
#                     "total_leaks": 0,
#                     "message": "No leaks found for this email address"
#                 }
...
#                 "message": "Email leak API request timed out after 30 seconds"
#             }
#         )
...
#                 "message": f"API returned error: {e.response.text[:200] if e.response.text else str(e)}"
#             }
#         )
...
#     import uvicorn
#     print("\n" + "="*70)
#     print("🚀 FORTECT API + EXTENSION SCRAPER + EMAIL LEAK CHECK")
#     print("="*70)
#     print("\n📦 Security Check Endpoints:")
#     print("  • /gsrcheck/?url=<url>")
#     print("  • /malware/?url=<url>")
#     print("  • /domain_age/?url=<url>")
#     print("  • /enhanced/?url=<url>")
#     print("  • /malware/enhanced/?url=<url>  ✅ NOW WORKING")
#     print("  • /super_fast/?url=<url>")
#     print("\n📧 Email Leak Check Endpoints:")
#     print("  • /email-leak/?email=<email>")
#     print("  • /email-leak/?email=<email>&from_date=7")
#     print("  • POST /email-leak/batch")
#     print("\n📦 Extension Scraper Endpoints:")
#     print("  • /extension/{id}")
#     print("  • /extension/{id}/basic")
#     print("  • /extension/{id}/privacy")
#     print("  • /extension/{id}/developer")
#     print("="*70 + "\n")
